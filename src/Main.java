...
public class Main {
    ...
    public static void main(String[] args)
    {
        ...
        String[] shell_sort = {"E","A","S","Y","S","H","E","L","L","S","O","R","T","Q","U","E","S","T","I","O","N"};

       // ElementarySorts.ShellSort(shell_sort);

        SortableLinkList<String> sll = new SortableLinkList<String>();
